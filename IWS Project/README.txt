...
# Features
Offers a feature for comparing both lease and loan options based on financial status and options that are provided by the user.

Technologies used:
1. Web development frameworks like JavaScript (Vue.js)
